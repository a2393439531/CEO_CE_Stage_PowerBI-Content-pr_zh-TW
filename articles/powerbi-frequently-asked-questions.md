...
是。 Power BI has native apps for Android phones, iOS devices, and Windows 10 devices. Download one of the <bpt id="p1">[</bpt>Power BI mobile apps<ept id="p1">](https://powerbi.microsoft.com/mobile)</ept> from its respective store:  
